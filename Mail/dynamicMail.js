...
async function otpSend(userMail,userName,otp){
    let htmlContent = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
            ...
            <!-- Body -->
            <div style="padding: 20px; background: #fffbea;">
                ...
                <div style="display: inline-block; background: #ffffff; padding: 15px 30px; border: 2px dashed #facc15; border-radius: 8px; font-size: 24px; font-weight: bold; letter-spacing: 4px; color: #000000;">
                    ${otp}
                </div>
                </div>
